...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid">
        <div className="flex flex-col mx-auto justify-center items-center lg:px-12 lg:justify-center md:flex-row md:justify-end xl:mx-auto rounded-xl md:h-auto pt-4 md md:pt-0 xl:pt-8 md:py-6 md:px-auto md:mx-auto xl:justify-center xl:py-9 bg-transparent xl:bg-linear-to-r xl:from-[#00BC7D] xl:via-[#219b72] xl:to-[#1f855c] mb-11 xl:shadow-xl xl:shadow-black/30">
    ...
    >
      ...
      <div>
        <input
          ...
          className={`w-full border-b border-gray-300 placeholder-gray-300 py-2 px-1 ${theme === "dark" ? "placeholder-gray-400 text-black xl:text-[#ffffff]" : "placeholder-gray-300 text-black  "} focus:outline-none  xl:placeholder-gray-400`}
        />
      </div>
      ...
      <div>
        <input
          ...
          className={`w-full border-b border-gray-300 placeholder-gray-300 py-2 px-1 ${theme === "dark" ? "placeholder-gray-400 text-black xl:text-[#ffffff]" : "placeholder-gray-300 text-black  "}  xl:placeholder-gray-400 focus:outline-none `}
        />
      </div>
      ...
      <div>
        <textarea
          ...
          className={`w-full h-32 border-b border-gray-300 placeholder-gray-300 py-2 px-1 ${theme === "dark" ? "placeholder-gray-400 text-black xl:text-[#ffffff]" : "placeholder-gray-300 text-black  "} focus:outline-none resize-none xl:placeholder-gray-400`}
        />
      </div>
