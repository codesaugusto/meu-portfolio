...
function ServiceCard({ icon, title, description }: ServiceCardProps) {
  ...
  if (isMobile) {
    return (
      ...
      >
        <div className="flex mx-auto md:mx-0 flex-col items-start md:items-center bg-[#00BC7D] rounded-2xl shadow-lg shadow-black/60 w-[18rem] h-[24rem] px-2 py-2 pb-7 md:pb-0 md:py-0 md:px-0 gap-3 md:w-[20rem] md:h-[25rem] xl:w-[25rem] xl:h-[31rem] md:p-4 md:gap-4">
          <div className="mx-auto mt-2 flex rounded-2xl w-[14rem] h-[11rem] select-none overflow-hidden md:mt-4 md:w-[17rem] md:h-[10rem] xl:w-[21rem] xl:h-[14rem]">
          ...
          <div className="px-4 mt-2 w-full">
            <h3 className="text-lg md:text-lg xl:text-xl font-bold font-poppins text-current text-center mb-2 select-none">
              {title}
            </h3>

            <p
              lang="pt-BR"
              className="text-sm md:text-sm font-semibold text-left font-poppins select-none mt-4 leading-relaxed"
            >
              {description}
            </p>
          </div>
    ...
    >
      <motion.div className="flex flex-col items-center bg-[#00BC7D] gap-4 rounded-2xl w-[18rem] h-[27rem] md:w-[20rem] md:h-[25rem] xl:w-[25rem] xl:h-[31rem] shadow-lg shadow-black/60 p-4">
        ...
        <div className="px-4 mt-2">
          <h3 className="text-lg md:text-lg xl:text-xl font-bold font-poppins text-current text-center md:text-center mb-1 md:mb-2 select-none">
            {title}
          </h3>
          <p
            lang="pt-BR"
            ...
            className="text-sm md:text-[0.93rem] xl:text-[1.09rem] font-semibold md:text-left font-poppins select-none break-words tracking-[-0.12px] mt-4 md:mt-5 md:tracking-[-0.08px] [word-spacing:-0.12rem] md:[word-spacing:-0.00rem] text-center"
          >
            {description}
          </p>
        </div>
...
const Services = () => {
  ...
  return (
    <div
      id="services"
      className="justify-center grid gap-12 md:px-2 px-10 pt-2 md:pt-12 xl:pt-20 xl:pb-30"
    >
      <h1 className="text-3xl md:text-4xl text-center flex justify-center items-center font-semibold font-poppins">
        Como posso te ajudar?
      </h1>
      {/* cards */}
      <div className="grid md:grid-cols-2 xl:grid-cols-3 grid-cols-1 justify-center gap-22 xl:px-0 md:gap-20 md:px-8 md:pr-8 xl:pr-0 xl:gap-22">
        <ServiceCard
          icon={
            <PiCoffeeFill
