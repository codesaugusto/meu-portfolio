...
const TechCarousel = () => {
  ...
  const TechItem = ({ tech }: { tech: Tech }) => {
    ...
    return (
      <div className="hidden md:flex flex-col items-center gap-2 text-appTextLight/80 hover:text-appTextLight transition select-none">
  ...
  return (
    <section className="relative w-full overflow-hidden py-16 mt-8 md:mt-16">
      {/* Fade esquerda */}
